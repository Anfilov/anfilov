...
export const sluzba = defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      options: {
        list: [
          ...
          { value: "firemni-tiskoviny", title: "Propagační tiskoviny" },
    ...
    defineField({
      ...
      title: "Problémy",
      type: "array",
      description: "1 až 3 problémy. Každý má ikonu a text.",
      ...
      of: [
        {
          ...
          fields: [
            defineField({
              ...
              title: "Ikona",
              type: "string",
              description: "Vyberte ikonu problému.",
              validation: (r) => r.required(),
              options: {
                list: [
                  ...
                  { title: "⏳ Hourglass — čekání, zdržení", value: "Hourglass" },
                  { title: "⏱️ Timer — spěch, odpočet", value: "Timer" },
                  { title: "💰 DollarSign — drahé, náklady", value: "DollarSign" },
                  { title: "🪙 Coins — finance, peníze", value: "Coins" },
                  { title: "🛡️ ShieldAlert — bezpečnostní riziko", value: "ShieldAlert" },
                  { title: "🛡️✖ ShieldX — nechráněno", value: "ShieldX" },
                  { title: "🔥 Flame — nebezpečí, hořící", value: "Flame" },
                  { title: "💀 Skull — kritické selhání", value: "Skull" },
                  { title: "🐛 Bug — chyba v systému", value: "Bug" },
                  { title: "👁️‍🗨️ EyeOff — neviditelné", value: "EyeOff" },
                  { title: "☁️ CloudOff — nedostupné", value: "CloudOff" },
                  { title: "🔒 Lock — zamčené, omezení", value: "Lock" },
                  { title: "🔗 Unlink — přerušené spojení", value: "Unlink" },
