      ...
      <Container className="relative pt-20 sm:pt-28 lg:pt-32 pb-10 sm:pb-14">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div>
            ...
            <p className="text-lg sm:text-xl text-[var(--color-text-secondary)] leading-relaxed font-[family-name:var(--font-body)] mb-10 max-w-[520px]">
            ...
            {/* Google Reviews element — links to Google reviews */}
            <a
